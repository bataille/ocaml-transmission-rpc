...
(* OASIS_START *)
(* DO NOT EDIT (digest: 7be89a1397bf99006c453699e721b4c7) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          license_file = None;
          copyrights = [];
          maintainers = ["Benoit Bataille <benoit.bataille@gmail.com>"];
          authors = ["Benoit Bataille <benoit.bataille@gmail.com>"];
          homepage =
            Some "https://github.com/bataille/ocaml-transmission-rpc";
          synopsis = "A library wrapping transmission-rpc";
          description =
            Some
              [
                 OASISText.Para
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Rpc"; "Client"; "Request"; "Answer"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "transmission-rpc";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "÷zòV\146©\025\130×põZ42Uc";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
